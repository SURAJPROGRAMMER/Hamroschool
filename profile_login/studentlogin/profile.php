...
<div class="main-content">
    ...
    <div class="profile-container">
        <div class="profile-header">
            ...
            <h2 id="user-name">Welcome, <?php echo htmlspecialchars($user['fullname']); ?>&nbsp;&nbsp;😎</h2>
        ...
        <button class="edit-btn"onclick="window.location.href='../uploading/unver.html'" id="Upload">Upload</button>
    </div>
</div>
